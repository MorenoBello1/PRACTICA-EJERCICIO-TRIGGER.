...
delete from matricula where id_matricula = 6--confirmar(F11)
delete from matricula where id_matricula = 5--confirmar(F11)
delete from matricula where id_matricula = 4--confirmar(F11)
delete from matricula where id_matricula = 3--confirmar(F11)
delete from matricula where id_matricula = 2--confirmar(F11)
delete from matricula where id_matricula = 1--confirmar(F11)
